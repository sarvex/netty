 ...
 */
public final class DefaultOpenSslApplicationProtocolNegotiator implements OpenSslApplicationProtocolNegotiator {
    private final ApplicationProtocolConfig config;
    public DefaultOpenSslApplicationProtocolNegotiator(ApplicationProtocolConfig config) {
